...
const io = require('socket.io')(http, { allowRequest: (req, fn) => {
...
// Only allow access from kameleon.io and localhost for security
io.origins(['https://kameleon.io:443', 'http://localhost:3000'])
